            ...
            <div class="col-md-8">
                <div class="product-content-right">
                    <div class="product-breadcroumb">
                        ...
                        <a href=""><c:out value="${product.getProductName()}"/></a>
                    </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="product-images">
                                <div class="product-main-img">
                                    <img src="<c:out value="${product.getImgURL()}"/>" alt="">;
                                </div>
...
<%--                                </div>--%>
                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                <h2 class="product-name"><c:out  value="${product.getProductName()}"/></h2>
                                <div class="product-inner-price">
                                    <ins><c:out value="${product.getPrice()}"/></ins>
                                </div>
