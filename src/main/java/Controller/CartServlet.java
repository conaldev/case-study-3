...
//        User customer = daoManager.userDAO.selectUserById(cusNumber);
...
//        User user = daoManager.userDAO.selectUserById(cusNumber);
//        Product product = daoManager.productDAO.selectProduct(productCode);
//        System.out.println("add to cart of : " + user.getUserFullName());
//        System.out.println("product selected : " + product.getId());
//
//
//        daoManager.cartDAO.insertCart(user, product);
//        List<Product> productList = daoManager.productDAO.selectAllProduct();
//        request.setAttribute("customer", user);
//        request.setAttribute("productList", productList);
...
//        System.out.println("userNumber :" + request.getParameter("userNumber"));
//        System.out.println("dang thanh toan");
//        int userNumber = Integer.parseInt(request.getParameter("userNumber"));
//
//        User user = daoManager.userDAO.selectUserById(userNumber);
//        List<Cart> cartList = daoManager.cartDAO.selectAllCart(userNumber);
...
//            daoManager.orderDAO.insertOrder(new Order(orderNumber,productCode,userNumber,quantity,status,currentDate));
//        }
